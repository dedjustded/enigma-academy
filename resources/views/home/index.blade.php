                            ...
                            <div class="menu-wrapper d-flex align-items-center justify-content-end">
                                ...
                                <nav>
                                            <ul id="navigation">                                                                                          
                                                ...
                                                <li><a href='guest/trainings'>Courses</a></li>
                                            ...
                                            <li><div class="text-end">
                                            <li><a href="viewMyDetails" class="btn btn-outline-light me-2">My Profile</a></li>
                                            </div>
                                                @endauth
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-12">
                                <div class="hero__caption">
                                    ...
                                    <a href="guest/trainings" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.7s">View our courses</a>
                                </div>
                            </div>
                        </div>
                    </div>          
                ...
                <div class="right-content1">
                    ...
                    <div class="right-img">
                        ...
                        <div class="video-icon" >
                            <a class="popup-video btn-icon" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ"><i class="fas fa-play"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="topic-img">
                                ...
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href='/admin/trainings'>Programing</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="section-tittle text-center mt-20">
                            <a href='/admin/trainings' class="border-btn">View More Subjects</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="team-active">
                    <div class="single-cat text-center">
                        ...
                        <div class="cat-cap">
                            <h5><a href="#">Kiril Bardarov </a></h5>
                            <p>*imagine creative intro text*</p>
                        </div>
                    </div>
                    </div>
                </div>
