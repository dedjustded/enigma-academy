    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="module_class">
                <label for="chooseLecture">Modules: </label>
                @if(!$modules->isEmpty())
                <div class="dropdown">
                    <button class="dropbtn">Available modules</button>
                    <div class="dropdown-content">
                        @foreach($modules as $module)
                        <a href="/admin/grades-absences/{{$student->id}}/{{$training->id}}/{{$module->id}}">{{$module['name']}}</a>
                        @endforeach
                    </div>
                </div>
                @else
